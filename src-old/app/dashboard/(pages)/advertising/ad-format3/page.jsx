                  ...
                  {/* <tr className="winner__table">
                                  <th colspan="15">
                                      <div className="table_menu">
                                          <ul>
                                              <li><a href="#" className="active">Keywords (0)</a></li>
      ...
      <div className="row">
        ...
        {/* <div className="col-lg-6 col-12">
              <div className="row adverCheck">
                  ...
                  <div className="col-md-3 col-6">
                      <div className="d-flex align-items-center">
                          <input id="cb1" className="checkbox" type="checkbox" checked>
                          <span className="ps-3"> Auto Creative</span>
                      </div>
                  </div>
              </div>
                ...
                <div className="video-custom position-relative">
                  <div className="play-pause">
                   ...
                   <Image src={`${baseUrl}front/assets/images/0001.jpg`}
                                        ...
                                        style={{width:"auto", height:"auto"}}
                                        /> 
                  {/* <iframe className="iframeVideo" src="assets/images/0001.png"
