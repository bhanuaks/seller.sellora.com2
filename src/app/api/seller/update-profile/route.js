...
async function updateTaxInformation(request) { 
    ...
    if(u_s_resident=="Yes"){
        ...
        if(isEmpty(citizenship))errors.citizenship = "citizenship is required.";
        if(isEmpty(country_of_organization))errors.country_of_organization = "Country of organization is required.";
        if(isEmpty(name_of_organization))errors.name_of_organization = "Name of organization is required.";
        // if(isEmpty(trade_name))errors.trade_name = "trade name is required.";
        // if(isEmpty(business_regristation_number))errors.business_regristation_number = "This field is required.";
        if(isEmpty(tin_number))errors.tin_number = "This field is required.";
 ...
 async function updateBankDetails(request) {
    ...
    const {_id, seller_id, account_holder_name, bank_name, bank_address, account_number, routing_number, country, zipcode, state,
        ifsc_code,
        sort_code,
    ...
    const errors ={}; 
        ...
        if(country =="India"){
            if(isEmpty(ifsc_code))errors.ifsc_code = "IFSC code is required."; 
        }

        if(country =="United Kingdom"){
            if(isEmpty(sort_code))errors.sort_code = "Sort code is required."; 
        }
