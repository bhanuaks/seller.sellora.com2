...
function page() {
  ...
  async function saveEmails(name) {
    ...
    if (
      !formData?.[`${name}Email`] ||
      !isValidEmail(formData?.[`${name}Email`])
    ) {
  ...
  async function saveEmergencyInfo(e) {
    ...
    if (
      ...
      !isValidEmail(formData.EmergencyNotificationEmail)
    ) {
            ...
            <div className="content_areya">
              <div className="mb-5">
                <p>
                  ...
                  important notifications related to your account. (Not all
                      ...
                      <div className="row_outer">
                        ...
                        <div className="edit-icon">
                          {updateField == "ListingCreation" ? (
                            <a onClick={(e) => saveEmails("ListingCreation")}>
                              Save
                            </a>
                          ) : (
                            <i
                              className="fa fa-pencil"
                              onClick={(e) => setUpdateField("ListingCreation")}
                            />
                          )}
                        </div>
                      </div>
                      <div className="row_outer">
                        ...
                        <div className="edit-icon">
                          {updateField == "ComplianceRequirements" ? (
                            <a
                              onClick={(e) =>
                                saveEmails("ComplianceRequirements")
                              }
                            >
                              Save
                            </a>
                            ...
                            <i
                              className="fa fa-pencil"
                              onClick={(e) =>
                                setUpdateField("ComplianceRequirements")
                              }
                            />
                          )}
                        </div>
                      ...
                      <div className="row_outer">
                        ...
                        <div className="edit-icon">
                          {updateField == "ListingRecommendations" ? (
                            <a
                              onClick={(e) =>
                                saveEmails("ListingRecommendations")
                              }
                            >
                              Save
                            </a>
                            ...
                            <i
                              className="fa fa-pencil"
                              onClick={(e) =>
                                setUpdateField("ListingRecommendations")
                              }
                            />
                          )}
                        </div>
                      ...
                      <div className="row_outer">
                        ...
                        <div className="edit-icon">
                          {updateField == "NewOrder" ? (
                            ...
                            <i
                              className="fa fa-pencil"
                              onClick={(e) => setUpdateField("NewOrder")}
                            />
                          )}
                        </div>
                      </div>
                      <div className="row_outer">
                        ...
                        <div className="checkbox">
                          <input
                            ...
                            checked={
                              formData?.NewOrderCancellationRisk || false
                            }
                            onChange={(e) => hendleChangecheckBox(e)}
                          />
                        </div>
                        ...
                        <div className="edit-icon">
                          {updateField == "NewOrderCancellationRisk" ? (
                            <a
                              onClick={(e) =>
                                saveEmails("NewOrderCancellationRisk")
                              }
                            >
                              Save
                            </a>
                            ...
                            <i
                              className="fa fa-pencil"
                              onClick={(e) =>
                                setUpdateField("NewOrderCancellationRisk")
                              }
                            />
                          )}
                        </div>
                      ...
                      <div className="row_outer">
                        ...
                        <div className="edit-icon">
                          {updateField == "NewReturnRequest" ? (
                            <a onClick={(e) => saveEmails("NewReturnRequest")}>
                              Save
                            </a>
                          ) : (
                            <i
                              className="fa fa-pencil"
                              onClick={(e) =>
                                setUpdateField("NewReturnRequest")
                              }
                            />
                          )}
                        </div>
                      ...
                      <div className="row_outer">
                        ...
                        <div className="edit-icon">
                          {updateField == "ReturnDelivered" ? (
                            <a onClick={(e) => saveEmails("ReturnDelivered")}>
                              Save
                            </a>
                          ) : (
                            <i
                              className="fa fa-pencil"
                              onClick={(e) => setUpdateField("ReturnDelivered")}
                            />
                          )}
                        </div>
                      </div>
                      <div className="row_outer">
                        ...
                        <div className="edit-icon">
                          {updateField == "RefundIssued" ? (
                            <a onClick={(e) => saveEmails("RefundIssued")}>
                              Save
                            </a>
                          ) : (
                            <i
                              className="fa fa-pencil"
                              onClick={(e) => setUpdateField("RefundIssued")}
                            />
                          )}
                        </div>
                      </div>
                      ...
                      <div className="row_outer">
                        ...
                        <div className="checkbox">
                          <input
                            ...
                            checked={
                              formData?.AdvertisementRecommendation || false
                            }
                            onChange={(e) => hendleChangecheckBox(e)}
                          />
                        </div>
                        <div className="input-container">
                          ...
                          <input
                            ...
                            value={
                              formData.AdvertisementRecommendationEmail || ""
                            }
                            onChange={(e) => hendleChangeInput(e)}
                            disabled={
                        ...
                        <div className="edit-icon">
                          {updateField == "AdvertisementRecommendation" ? (
                            <a
                              onClick={(e) =>
                                saveEmails("AdvertisementRecommendation")
                              }
                            >
                              Save
                            </a>
                            ...
                            <i
                              className="fa fa-pencil"
                              onClick={(e) =>
                                setUpdateField("AdvertisementRecommendation")
                              }
                            />
                          )}
                        </div>
                      ...
                      <div className="row_outer">
                        ...
                        <div className="edit-icon">
                          {updateField == "PriceRecommendation" ? (
                            <a
                              onClick={(e) => saveEmails("PriceRecommendation")}
                            >
                              Save
                            </a>
                          ) : (
                            <i
                              className="fa fa-pencil"
                              onClick={(e) =>
                                setUpdateField("PriceRecommendation")
                              }
                            />
                          )}
                        </div>
                      ...
                      <div className="row_outer">
                        ...
                        <div className="edit-icon">
                          {updateField == "SelloraPromotions" ? (
                            <a onClick={(e) => saveEmails("SelloraPromotions")}>
                              Save
                            </a>
                          ) : (
                            <i
                              className="fa fa-pencil"
                              onClick={(e) =>
                                setUpdateField("SelloraPromotions")
                              }
                            />
                          )}
                        </div>
                      ...
                      <div className="row_outer">
                        ...
                        <div className="edit-icon">
                          {updateField == "ReportStatus" ? (
                            <a onClick={(e) => saveEmails("ReportStatus")}>
                              Save
                            </a>
                          ) : (
                            <i
                              className="fa fa-pencil"
                              onClick={(e) => setUpdateField("ReportStatus")}
                            />
                          )}
                        </div>
                      </div>
        ...
        <div className="modal-dialog modal-dialog-centered">
          <div className="modal-content">
            ...
            <div className="modal_a">
              <a type="a" className="orange-btn cancel" data-bs-dismiss="modal">
                Cancel
              </a>
