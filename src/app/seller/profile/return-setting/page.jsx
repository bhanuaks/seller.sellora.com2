...
function page() {
      ...
      .then((res) => {
        ...
        if (res.status) {
          ...
          const modal = bootstrap.Modal.getOrCreateInstance(
            document.getElementById("return-address-Modal")
          );
          modal.hide();
  ...
  function saveFeedback(){
    ...
    fetch(`${baseUrl}api/seller/send-feedback-admin`, {
      method: "POST",
                ...
                <div className="row">
                  ...
                  <div className="col-lg-8">
                    <div className="re_40540">
                      ...
                      <p>
                        Sellora automatically approves all return requests based
                        on your predefined return settings and policies. For any
                        exceptions to these rules, customers will reach out to
                        you directly through buyer questions
                      </p>
                      <h4>Refunds</h4>
                      <label>
                        <input
                  ...
                  <div className="col-lg-8">
                    <div className="re_40540">
                      ...
                      <p>
                        ...
                        sellers need no action. Our industry-standard policy
                        ensures shopper peace of mind during holidays, building
                    ...
                    <div className="row">
                      ...
                      <div className="col-lg-3">
                        <div className="second_heding">
                          ...
                          <p>
                            {addressDataShow.city}, {addressDataShow.state},{" "}
              ...
              <div className="return_setting_outer">
                <div className="row">
                  <div className="col-lg-4">
                    ...
                    <p>
                      Enable or disable replacements in specific departments
                    </p>
                  </div>
                  <div className="col-lg-8">
                    <div className="row">
                  ...
                  <div className="col-lg-9">
                    <div className="input-group feedback">
                      ...
                      <div className="input-group-append">
                        <button className="ask" type="button" onClick={()=>saveFeedback()}
                          disabled={isFeedbackProcessing}>
                          {isFeedbackProcessing?"Please wait..":"Feedback"}
                        </button>
                      </div>
                    </div>
                  </div>
