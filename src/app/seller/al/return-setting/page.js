...
const page = () => {
  ...
  useEffect(() => {
    fetch(`/api/front/get-active-category`)
      .then((response) => {
        if (!response.ok) {
  ...
  useEffect(() => {
    if (globalData.sellor) {
      ...
      fetch(
        `/api/seller/get-profile?user_id=${globalData.sellor._id}&with_data=returnAddress`,
        {
          method: "GET",
        }
      )
      ...
      fetch(
        `/api/seller/update-profile/return-window?seller_id=${globalData.sellor._id}`,
        {
          method: "GET",
        }
      )
        ...
        .then((res) => {
          ...
          if (res.status) {
            ...
            setReplacementData(res.data.replacement);
          }
        });
    }
  }, [globalData.sellor]);
      ...
      .then((res) => {
        ...
        if (res.status) {
          ...
          const modal = bootstrap.Modal.getOrCreateInstance(
            document.getElementById("rules-by-department-Modal")
          );
          modal.hide();
        } else if (res.data.status_code == 403) {
  ...
  const submitUpdateReturnReplacement = (e) => {
    e.preventDefault();
    setIsProcessing(true);
    fetch(`${baseUrl}api/seller/update-profile/update-replacement-setting`, {
      method: "POST",
      body: JSON.stringify({
        seller_id: sellor._id,
      ...
      .then((res) => {
        if (res.status) {
          toast.success("Success! Update replacement setting.");
          const modal = bootstrap.Modal.getOrCreateInstance(
            document.getElementById("replacements-by-department-Modal")
          );
          modal.hide();
        }
      });
  ...
  const updateInputDataReplacement = (name, value) => {
              ...
              <div className="row">
                <div className="col-lg-12">
                  <div className="content_areya border__10_6">
                      ...
                      <div className="row">
                        <div className="col-lg-4">
                          <div className="return_0344">
                            General Returns Settings
                          </div>
                        </div>
                        <div className="col-lg-8">
                          <div className="re_40540">
                            <h2>
                              RMA (Return Merchandise Authorization) Rules
                            </h2>
                            <p>
                              Sellora automatically approves all return requests
                              based on your predefined return settings and
                              policies. For any exceptions to these rules,
                              customers will reach out to you directly through
                              buyer questions
                            </p>
                            <h4>Refunds</h4>
                            <label>
                              ...
                              />
                              I will manually issue all refunds within 48 hours
                              of receiving returned items
                            </label>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="row">
                        ...
                        <div className="col-lg-8">
                          <div className="re_40540">
                            ...
                            <p>
                              Sellora's return window updates automatically, so
                              sellers need no action. Our industry-standard
                              policy ensures shopper peace of mind during
                              holidays, building trust and loyalty with your
                              customers
                            </p>
                          </div>
                        </div>
                          ...
                          <div className="row">
                            ...
                            <div className="col-lg-3">
                              <div className="second_heding">
                                ...
                                <p>
                                  {addressDataShow.city},{" "}
                                  {addressDataShow.state},{" "}
                                  {addressDataShow.zip_code}
                                </p>
                              </div>
                            </div>
                            <div className="col-lg-3">
                    ...
                    <div className="return_setting_outer">
                      <div className="row">
                        <div className="col-lg-4">
                          ...
                          <p>
                            Enable or disable replacements in specific
                            departments
                          </p>
                        </div>
                        <div className="col-lg-8">
                    ...
                    {sellor?.complete_step && sellor?.complete_step >= 4 && ( 
                        <div className="mlrtb">
                          <div className="row">
                            <div className="col-lg-6">
                              <Link href={"/seller/al/business-details"}>
          ...
          <div className="modal-content">
            <form action="#" onSubmit={(e) => submitUpdateForm(e)}>
              <div className="modal-header">
                <h5
                  className="modal-title title_request"
              ...
              <div className="modal-body">
                <div className="request_form">
                  <label>
                    Display name<span className="mandatory_field">*</span>
                  </label>
                  <input
                    type="text"
                    placeholder=""
                  ...
                  <label>
                    Address Line 1<span className="mandatory_field">*</span>
                  </label>
                  <input
                    type="text"
                    placeholder=""
                  ...
                  <label>
                    Return Address (Not printed on the return label)
                  </label>
                  <input
                    type="text"
                    placeholder=""
                    ...
                    onChange={(e) => updateInputData(e)}
                  />
                  {errors.return_address && errors.return_address != "" ? (
                    <span
                      id="name_error"
                      className="input-error-tip"
                      style={{ display: "inline-block" }}
              ...
              <div className="modal_button">
                ...
                <button className="orange-btn" disabled={isProcessing} >{isProcessing?"Please wait..":"Save"}</button>
              </div>
            </form>
          </div>
        </div>
          ...
          <div className="modal-content">
            <form action="#" onSubmit={(e) => submitUpdateReturnWindow(e)}>
              ...
              <div className="modal-body">
                <div className="request_form">
                  <p>
                    Please see the Marketplace Return’s Policy for return
                    center.
                  </p>
                  ...
                  <div className="table-responsive">
                    ...
                    >
                      ...
                      <tbody>
                        {allCategory &&
                          allCategory.map((categoryList, index) => {
                            return (
                              <tr
                    ...
                    >
                      <thead className="table__head">
                        <tr className="winner__table">
                          ...
                          <th width={330}>Replacements Enabled ? </th>
                        </tr>
                      </thead>
                      <tbody>
                        {allCategory &&
                              ...
                              >
                                ...
                                <td>
                                  ...
                                  <div className="container">
                                      ...
                                      <div className="radio">
                                        <input
                                              id={`radio-yes-${categoryList._id}`}
                                              name={categoryList._id}
                                              type="radio"
                                              value="Yes"
                                              checked={replacementData?.[categoryList._id] === "Yes"}
                                              onChange={(e) =>
                                                updateInputDataReplacement(categoryList._id, e.target.value)
                                              }
                                            />
                                        
                                        <label htmlFor={`radio-yes-${categoryList._id}`} className="radio-label">
                                          Yes{" "}
                                        </label>
                                      </div>
                                      <div className="radio">
                                        <input
                                          id={`radio-no-${categoryList._id}`}
                                          name={categoryList._id}
                                          type="radio"
                                          value="No"
                                          checked={replacementData?.[categoryList._id] === "No"}
                                         onChange={(e) =>
                                                updateInputDataReplacement(categoryList._id, e.target.value)
                                              }
                                        />
                                        <label htmlFor={`radio-no-${categoryList._id}`} className="radio-label">
                                          No
                                        </label>
                                      </div>
