...
<>
  <p>
    <strong>Single Product Listing</strong>
  </p>
  <div className="video-container">
    <iframe
      width={560}
      height={315}
      src="https://www.youtube.com/embed/hYiOM4Nwlnw?si=cQ9ulFxh9pAihTHC"
  ...
  <p>Learn how to list a single product on Sellora</p>
  <p>
    <strong>What You'll Learn in This Video</strong>
  </p>
  <ul>
    <li>Steps to List a Single Product on Sellora</li>
    <li>Fill in Product Information</li>
    <li>Step-by-Step List product Process</li>
  </ul>
  <p />
  <div className="container">
