...
<>
  <p>
    <strong>Brand Approval</strong>
  </p>
  <div className="video-container">
    <iframe
      width={560}
      height={315}
      src="https://www.youtube.com/embed/5ldap9msyRw?si=QW-QUblI7ixZv2hv"
  ...
  <p>
    Learn how to submit your brand for approval and start selling branded
    products on Sellora.
  </p>
  <p>
  ...
  <ul>
    <li>What is Brand Approval?</li>
    <li>How to Apply for Brand Approval</li>
    <li>Documents Required for Brand Approval</li>
    <li>Step-by-Step Brand Approval Process</li>
  </ul>
  <p />
  <div className="container">
