...
const pathname = usePathname();
      ...
      <div className="col-lg-12">
        <div className="notification_breadcomb mb-6">
          <ul>
            ...
            <li>
              <a href="#">Prohibited products &amp; brands</a>{" "}
            </li>
          </ul>
        </div>
      </div>
  ...
  <>
  <h2>Prohibited products &amp; brands</h2>
  <h3>In this guide</h3>
  ...
  <div className="section-box ">
    ...
    <p>
      ...
      <br />
      This policy outlines the types of products that are strictly prohibited on
      the Sellora Marketplace. Sellers are responsible for ensuring that their
      product listings follow all relevant rules and standards. Non-compliance
      may result in the removal of listings, suspension of selling privileges,
      or other enforcement actions.{" "}
    </p>
  </div>
  <h3>What is the policy?&nbsp;</h3>
  <p>
    To maintain a compliant and secure marketplace,{" "}
    <strong>
      {" "}
      all products listed for sale on Sellora.com must adhere to the following
      requirements:
    </strong>
  </p>
  <p>
  ...
  <ul>
    ...
    <li>
      <strong>Product labels, descriptions, and images:</strong>
      <ul>
        <li>
          <strong>
            Must be in English.Must not contain conflicting or misleading
            information.
          </strong>
        </li>
        <li>
          <strong>
            May include other languages only if English is also present.
          </strong>
        </li>
        <li>
          <strong>
            Product information must align with the National Institute of
            Standards and Technology (NIST) Handbook 130 – Current Edition, IV.
            Uniform E-Commerce Regulation, where applicable.
          </strong>
        </li>
        <li>
          <strong>
            Shipping labels must meet all legal requirements and those of any
  ...
  <p>
    <strong>Sellora strictly prohibits the following:</strong>
  </p>
  <ul>
    <strong>
      ...
      <p>
        <strong>
          This is illegal and violates intellectual and property rights.
        </strong>
      </p>
      <li>Retail Arbitrage &amp; Unauthorized Fulfillment</li>
      <li>
  ...
  <p />
  <p>
    <strong>3. Enforcement &amp; Responsibility</strong>
  </p>
  <ul>
    <li>
    ...
    <strong> update or remove product categories</strong> or territories in its{" "}
    <strong>Prohibited Products Policy at any time without notice.</strong>
  </ul>
  <p />
  <div className="notes_11">
    ...
    <p>
      ...
      seller on Sellora Marketplace,{" "}
      <strong> you are solely responsible</strong> for ensuring that your
      products and listings comply with the{" "}
      <strong> most current version</strong> of this policy, including any
      ...
      <tbody>
        <tr>
          <td style={{ fontWeight: 400 }}>
            <p>
              Neither you, your company, your beneficial owners, nor any
              officer, director, employee, agent, or third-party representative
              acting on your behalf may be listed on any{" "}
              <strong> Restricted Party List</strong>, including but not limited
              to:
            </p>
            <ul>
              <li>
                {" "}
                <strong>Office of Foreign Assets Control (OFAC)</strong>{" "}
                Specially Designated Nationals (SDN) List
              </li>
              <li>
                Other U.S. or international sanctions or restriction lists
              </li>
            </ul>
          ...
          <td>
            <p>
              Contain materials, components, or ingredients produced through the
              use of forced labor
            </p>
            <p>
              Involve production, sourcing, processing, or transportation
              through the following <strong> prohibited regions:</strong>
            </p>
            <ul>
              <strong>
                <li>Iran</li>
            ...
            <p>
              Are connected to{" "}
              <strong> sanctioned individuals or entities</strong>, even if
              outside the above territories
            </p>
            <p>
              Are produced in whole or part by any entity or region that would
              cause the product to be prohibited from U.S. entry under{" "}
              <strong> 19 U.S.C. § 1307</strong>, or are subject to{" "}
              <strong>withhold release orders </strong> or other U.S.{" "}
              <strong> government trade restrictions</strong>
            </p>
          </td>
        </tr>
      </tbody>
  ...
  <ul>
    <li>
      Other sanctions may apply to products from{" "}
      <strong> territories not listed </strong>above.
    </li>
    <li>
  ...
  <p>
    ...
    <strong>strictly prohibited or subject to additional restrictions</strong> .
    Each category may have unique compliance requirements, and failure to meet
    them may result in your item being{" "}
    <strong>automatically unpublished</strong> or your account being{" "}
  ...
  <div className="table-container2">
    <table>
      <tbody>
        <tr>
          <td width="50%" style={{ fontWeight: 400 }}>
            <ul>
              <li>Alcohol</li>
              <li>Animals</li>
              <li>Art</li>
              ...
              <li>Electronics and Radio Frequency </li>
              <li>Devices</li>
              <li>Food Products</li>
              ...
              <li>PreciousGemstones, Currency, Coins </li>
              <li>and Precious Metals (Covered Goods)</li>
          ...
          <td>
            <ul>
              ...
              <li>Weapons</li>
              <li>
                Air Powered Guns, BB Guns, Toy Guns and Imitation Firearms
              </li>
              <li>Firearms</li>
  ...
  <h3>Sellora’s handling of your Prohibited Products</h3>
  <p>
    Sellora reserves the right to{" "}
    <strong> unpublish, remove, or take enforcement action</strong> against any
    product listings that violate our{" "}
    <strong> Prohibited Products Policy</strong>.
  </p>
  <h3>Inventory Management of Prohibited Items</h3>
  <p>
    If prohibited products are in Sellora’s possession—either through{" "}
    <strong> Sellora Fulfillment Services (SFS)</strong> or otherwise—Sellora
    may manage the inventory in the following ways:
  </p>
  <ul>
    <li>
      {" "}
      <strong>As required by law enforcement or regulatory agencies</strong>
    </li>
    <li>
      {" "}
      <strong>As determined appropriate at Sellora’s sole discretion</strong>
    </li>
  </ul>
  <p>
  ...
  <ul>
    ...
    <li>
      {" "}
      <strong>Destroy or dispose of</strong> the products
    </li>
    <li>
      {" "}
  ...
  <div className="notes_11">
    ...
    <p>
      ...
      for <strong>general informational purposes only</strong> and{" "}
      <strong>should not be considered legal advice.</strong>
      <br />
      This policy may contain{" "}
      <strong> hyperlinks to third-party content</strong>. Sellora does{" "}
    ...
    <div className="accordion-item">
      ...
      <div className="accordion-content">
        ...
        <ol style={{ marginLeft: 20 }}>
          ...
          <li style={{ color: "black" }}>
            Gather any <strong> supporting documentation or evidence</strong>{" "}
