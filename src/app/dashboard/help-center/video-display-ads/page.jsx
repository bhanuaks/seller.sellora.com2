...
<>
  <p>
    <strong>Video Display Ads</strong>
  </p>
  <div className="video-container">
    <iframe
      width={560}
      height={315}
      src="https://www.youtube.com/embed/zALDZ1UfAy8?si=z5p9h8C2e_JmLQnB"
  ...
  <p>
    Learn how to create and launch video display ads that boost product
  ...
  <ul>
    <li>What Video Display Ads.</li>
    <li>How do Video Display Ads work on Sellora.&nbsp;</li>
    <li>Create Video Display Ads step-by-step.</li>
    <li>Upload custom videos to specific products or landing pages.</li>
