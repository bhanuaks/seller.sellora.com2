...
import { attachMenuListeners } from './menuListeners';

function LeftSideBar() {

    const pathname = usePathname(); // updates on every route change
useEffect(() => {
    const cleanup = attachMenuListeners('.sidebar-desktop');
  ...
  return (
    ...
    <div className="col-lg-3 d-lg-block d-none" style={{ paddingLeft: 0 }}>
        <div className="sticky_top sidebar2">
          <div className="sidebar-desktop sidebar_10_7">
            ...
            <ul className="menu_10_7">
              ...
              <li>
                ...
                <ul className="submenu_10_7">
                  ...
                  <li>
                    <div className="submenu-header_10_7">Variant Set Guide</div>
                    <ul className="childmenu_10_7">
                      <li>
              ...
              <li>
                ...
                <ul className="submenu_10_7">
                  ...
                  <li>
                    <div className="submenu-header_10_7">Customer Support</div>
                    <ul className="childmenu_10_7">
                      <li>
              ...
              <li>
                <div className="menu-header_10_7">Policies &amp; Standards</div>
                <ul className="submenu_10_7">
                  <li>
