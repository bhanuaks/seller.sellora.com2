...
<>
  ...
  <div className="video-container">
    <iframe
      width={560}
      height={315}
      src="https://www.youtube.com/embed/5ldap9msyRw?si=BUS1CW0FaScKZrVf"
  ...
  <p>
    we walk you through the complete onboarding process to start selling on
    Sellora.
  </p>
  <p>
  ...
  <ul>
    <li>How to Register as a Seller on Sellora</li>
    <li>Complete onboarding in Seller Center</li>
    <li>Step-by-Step Account Setup Process</li>
  </ul>
  <p />
  <div className="container">
