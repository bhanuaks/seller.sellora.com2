...
<>
  <p>
    <strong>Smart Campaign</strong>
  </p>
  <div className="video-container">
    <iframe
      width={560}
      height={315}
      src="https://www.youtube.com/embed/lIb1zkEZd8M?si=5UCLkboJ2f2t4Qyn"
  ...
  <p>
    Learn how to set up a smart campaign that handles targeting and bidding for
    you
  </p>
  <p>
  ...
  <ul>
    <li>What a Smart Campaign</li>
    <li>Create Smart ad campaigns step-by-step.</li>
    <li>Improve visibility and increase sales with smart ads.&nbsp;</li>
  </ul>
  <p />
  <div className="container">
