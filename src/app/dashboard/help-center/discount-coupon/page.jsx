...
<>
  ...
  <div className="video-container">
    <iframe
      width={560}
      height={315}
      src="https://www.youtube.com/embed/s7U6FXvGSrI?si=X3ynaeMZntdlKvpF"
  ...
  <ul>
    <li>What a Discount Coupon.</li>
    <li>Create your own coupon offers</li>
    <li>Use coupons to attract new buyers and increase conversions</li>
  </ul>
  <p />
  <div className="container">
