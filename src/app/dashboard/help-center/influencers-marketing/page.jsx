...
<>
  ...
  <div className="video-container">
    <iframe
      width={560}
      height={315}
      src="https://www.youtube.com/embed/gqSOl4jNJ-A?si=u0N7KPzBLdhhbcqz"
  ...
  <p>
    Learn how to set up discount coupons to give customers more reasons to buy.
  </p>
  <p>
    <strong>What You'll Learn in This Video</strong>
  </p>
  <ul>
    <li>What Influencer Marketing.</li>
    <li>How to Participate on Influencer Marketing</li>
    <li>Build long-term influencer partnerships to grow your brand faster</li>
  </ul>
  <p />
  <div className="container">
