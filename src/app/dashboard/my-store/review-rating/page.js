        ...
        <div className="row">
          <div className="col-lg-12 ">
            <div className="store_logo">
              {data.profileLogo && <img src={`/${data.profileLogo}`} />}
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="container">
        <div className="row">
          <div className="col-lg-10 offset-lg-1 ">
                        ...
                        <div className="row align-items-center">
                              ...
                              <input
                                ...
                                value={(() => {
                                  if (feeddback && reviewData) {
                                    ...
                                    const totalCount =
                                      feeddback.count + reviewData.count;
                          ...
                          <div className="col-lg-8 offset-lg-1">
                            <div className="rating_review">
                              <ul>
                                <li onClick={()=>setViewTypeList("Vendor Feedback")} style={{cursor:'pointer'}}>
                                ...
                                <li onClick={()=>setViewTypeList("Reviews")} style={{cursor:'pointer'}} >
            ...
            <div style={{width:'100%', display:'flex', justifyContent: 'center' }}><h4>{viewTypeList}</h4></div>
            <div className="row">
                      ...
                      <div className="row">
                        <div className="col-lg-2">
                          <div className="_testi_img">
                            {" "}
                            <img src={`${fileBasePath}/${product.mainImage}`} />{" "}
                          </div>
                        </div>
                            ...
                            <div className="product-status3">
                              <div className="rating-stars-group_sdf">
                                  <div className="rating-star_02">
                                             <i className={`fa-star${product?.avgStar >0 && product?.avgStar < 1?"-half-alt fa-solid selected":""}  ${product?.avgStar >=1?"fa-solid selected":"fa-light"}`} />
                                         </div>
                                         <div className="rating-star_02">
                                             <i className={`fa-star${product?.avgStar >1 && product?.avgStar < 2?"-half-alt fa-solid selected":""} ${product?.avgStar >=2?"fa-solid selected":"fa-light"}`} />
                                         </div>
                                         <div className="rating-star_02">
                                             <i className={`fa-star${product?.avgStar >2 && product?.avgStar < 3?"-half-alt fa-solid selected":""} ${product?.avgStar >=3?"fa-solid selected":"fa-light"}`} />
                                         </div>
                                         <div className="rating-star_02">
                                             <i className={`fa-star${product?.avgStar >3 && product?.avgStar < 4?"-half-alt fa-solid selected":""} ${product?.avgStar >=4?"fa-solid selected":"fa-light"}`} />
                                         </div> 
                                         <div className="rating-star_02">
                                             <i className={`fa-star${product?.avgStar >4 && product?.avgStar < 5?"-half-alt fa-solid selected":""} ${product?.avgStar >=5?"fa-solid selected":"fa-light"}`} /> 
                                         </div> 
                              </div>
                            </div>
                            <div className="row align-items-center">
