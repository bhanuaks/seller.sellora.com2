...
function Page() {
  ...
  async function LoadData() {
    fetch(`/api/seller/insights/customer-segments?filter=${filter}`)
      .then(async (response) => {
  ...
  async function LoadProduct() {
    setIsLoading(true);
    fetch(`/api/seller/insights/customer-segments-products?filter=${filter}`, {
      method: "POST",
                ...
                <div className="row">
                  ...
                  <div className="col-lg-3">
                    <div className="summry_box p-20">
                      ...
                      <div className="price02">
                        {formatNumber(summary.totalNewUsers || 0)}
                      </div>
                    </div>
                  </div>
                  <div className="col-lg-3">
                    <div className="summry_box p-20">
                      ...
                      <div className="price02">
                        {formatNumber(summary.repeatUsers || 0)}
                      </div>
                    </div>
                  </div>
                  {/* <div className="col-lg-3">
              ...
              <tbody>
                ...
                {productList && productList.length > 0 && productList.map((product, index)=>(
                  ...
                  <td className="text-center">
                    <div className="text_content">
                      <ul>
                        <li>{product.repeatUsersCount} </li>
                      </ul>
                    </div>
                  </td>
                  {/* <td className="text-center">
