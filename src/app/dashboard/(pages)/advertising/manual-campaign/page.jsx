...
async function submitCampaign(e){
  ...
  setErrors({});
  const newErrors = {};
  if(isEmpty(campaign.endDate)){
    newErrors.endDate="required.";
   $('input[name="endDate"]').focus();
  }
   if(isEmpty(campaign.startDate)){
     newErrors.startDate = "required.";
     $('input[name="startDate"]').focus();
  }
 
     if(campaign.budgetManually == "Yes" && isEmpty(campaign.dailyBudget)){
       newErrors.dailyBudget = "Daily Budget is required.";
     $('input[name="dailyBudget"]').focus();
  }

  if(campaign.campaignType == "Smart" && isEmpty(campaign.expectedROI)){
     newErrors.expectedROI = "required." 
     $('input[name="expectedROI"]').focus();
  }

 if(campaign.campaignType == "Manual" && isEmpty(campaign.defaultBid)){
