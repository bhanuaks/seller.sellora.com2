...
function Page() {
  ...
  const [addFormat, setAddFormat] = useState("Auto Creative")
  return (
    <>
  ...
  <div className="details_page_outer">
        ...
        <div className="col-lg-4 col-12">
          <div className="adfor_boxs1">
            ...
            <ul className="img-specs">
              <li>Image size: 1200 x 576 px or large</li>
    ...
    <div className="container pt-80">
      <div className="row">
            ...
            <div className="col-md-3 col-6">
              <div className="d-flex align-items-center">
                <input
                  ...
                  className="checkbox"
                  type="checkbox"
                  checked={addFormat == "Auto Creative"}
                  onChange={(e)=>setAddFormat("Auto Creative")}
                />
            ...
            <div className="col-md-3 col-6">
              <div className="d-flex align-items-center">
                <input id="cb1" className="checkbox" type="checkbox" 
                  checked={addFormat == "Rich Creative"}
                  onChange={(e)=>setAddFormat("Rich Creative")}
                  />
        ...
        {addFormat == "Auto Creative" && (
          <AutoCreativeFormat />
        )}

            {addFormat == "Rich Creative" && (
            <RichCreativeFormat />
          )}
