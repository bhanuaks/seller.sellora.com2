...
import { fetcher, main_thumb_img_path } from "@/Http/helper";
...
function page({params}) {
  ...
  useEffect(() => {
    setIsLoading(true)
    fetch(`/api/seller/user-feedback?product_id=${productId}`)
      .then((response) => {
        setIsLoading(false)
        if (!response.ok) {
      ...
      <div className="container">
        <div className="row">
          <div className="col-lg-10 offset-lg-1 ">
            ...
            <div style={{width:'100%', display:'flex', justifyContent: 'center' }}><h4>Feedback</h4></div>
            <div className="row">
